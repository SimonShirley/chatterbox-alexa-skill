...
var strings = {
    ...
    'resume_launch_message' : '<speak>You were listening to edition number <say-as interpret-as="cardinal">{0}</say-as>, recorded on <say-as interpret-as "date">{1}</say-as>. Would you like to resume?</speak>',
